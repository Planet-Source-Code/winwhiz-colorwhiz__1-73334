...
Picture1.Picture = LoadPicture(App.Path & "/Images/Help/safe.jpg")
Label1.Caption = "   Web safe color picker, clicking here loads web safe color choice as selected color."
End Sub
...
Me.Hide
frmHelp1.Show
frmHelp1.Picture1.Picture = LoadPicture(App.Path & "/Images/Help/javacode.jpg")
frmHelp1.Label1.Caption = "   Java color code."
frmInfo.Visible = False
End Sub
...
Picture1.Picture = LoadPicture(App.Path & "/Images/Help/safe1.jpg")
