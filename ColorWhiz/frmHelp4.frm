...
Me.Hide
frmHelp1.Show
frmHelp1.Picture1.Picture = LoadPicture(App.Path & "/Images/Help/Drivebox.jpg")
frmHelp1.Label1.Caption = "   Drivelist box, use to navigate to chosen drive on your computer."
frmInfo.Visible = False
End Sub
Private Sub Image2_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
Me.Hide
frmHelp1.Show
frmHelp1.Picture1.Picture = LoadPicture(App.Path & "/Images/Help/folderlist.jpg")
frmHelp1.Label1.Caption = "   Folderlist box, use to navigate to a specific folder on chosen drive."
frmInfo.Visible = False
End Sub
...
Me.Hide
frmHelp1.Show
frmHelp1.Picture1.Picture = LoadPicture(App.Path & "/Images/Help/filelist.jpg")
frmHelp1.Label1.Caption = "   Filelist box, use to navigate to a specific file in chosen folder, click the filelist box for more info."
frmInfo.Visible = False
End Sub
...
Me.Hide
frmHelp1.Show
frmHelp1.Picture1.Picture = LoadPicture(App.Path & "/Images/Help/syscolorname.jpg")
frmHelp1.Label1.Caption = "   System color name, name of the chosen system color."
frmInfo.Visible = False
frmHelp.timerScroll.Enabled = True
frmHelp.Picture1.Visible = True
frmHelp.Info.Top = 4
...
Me.Hide
frmHelp1.Show
frmHelp1.Picture1.Picture = LoadPicture(App.Path & "/Images/Help/syscolorcode.jpg")
frmHelp1.Label1.Caption = "   System color code."
frmInfo.Visible = False
frmHelp.timerScroll.Enabled = True
frmHelp.Picture1.Visible = True
frmHelp.Info.Top = 4
...
frmHelp1.Label1.Caption = "   Open an image file for display in the Image Viewer."
frmInfo.Visible = False
End Sub
...
Picture1.Picture = LoadPicture(App.Path & "/Images/Help/custom1.jpg")
Label1.Caption = "   Custom colors, after you have selected or captured a color, click a box here. Then click the add button and this color will be saved to your custom pallette"
frmInfo.Visible = False
End Sub
Private Sub Image12_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
Picture1.Picture = LoadPicture(App.Path & "/Images/Help/custom2.jpg")
Label1.Caption = "   This is your selected color, which can be added to your custom pallette. Click a box on the left then the add button to add this color."
End Sub
Private Sub Image13_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
Me.Hide
frmHelp1.Show
frmHelp1.Picture1.Picture = LoadPicture(App.Path & "/Images/Help/hexdisplay.jpg")
frmHelp1.Label1.Caption = "   placing a checkmark here displays the Hex values for Red,Green and Blue in the selected color."
frmInfo.Visible = False
End Sub
...
Me.Hide
frmHelp1.Show
frmHelp1.Picture1.Picture = LoadPicture(App.Path & "/Images/Help/qbname.jpg")
frmHelp1.Label1.Caption = "   QuickBasic color name."
frmInfo.Visible = False
End Sub
Private Sub Image20_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
Me.Hide
frmHelp1.Show
frmHelp1.Picture1.Picture = LoadPicture(App.Path & "/Images/Help/redvalue.jpg")
frmHelp1.Label1.Caption = "   Amount of red (1-255) in selected color."
frmInfo.Visible = False
End Sub
Private Sub Image21_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
Me.Hide
frmHelp1.Show
frmHelp1.Picture1.Picture = LoadPicture(App.Path & "/Images/Help/greenvalue.jpg")
frmHelp1.Label1.Caption = "   Amount of green (1-255) in selected color."
frmInfo.Visible = False
End Sub
Private Sub Image22_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
Me.Hide
frmHelp1.Show
frmHelp1.Picture1.Picture = LoadPicture(App.Path & "/Images/Help/bluevalue.jpg")
frmHelp1.Label1.Caption = "   Amount of blue (1-255) in selected color."
frmInfo.Visible = False
End Sub
Private Sub Image23_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
Picture1.Picture = LoadPicture(App.Path & "/Images/Help/custom1.jpg")
Label1.Caption = "   Add button, after you have selected or captured a color, click the box to the left. Then click the add button and this color will be saved to your custom pallette"
End Sub
...
Picture1.Picture = LoadPicture(App.Path & "/Images/Help/custom.jpg")
Label1.Caption = "   Allows you to choose between Safe and Custom colors."
End Sub

Private Sub Image37_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
Me.Hide
frmHelp1.Show
frmHelp1.Picture1.Picture = LoadPicture(App.Path & "/Images/Help/qbcode.jpg")
